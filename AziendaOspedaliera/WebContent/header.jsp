  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
     <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Prenota visita </a>
      <style type="text/css">
  ...
  <div class="input-group">
    ...
    <input id="Ora" type="hour" class="form-control" name="ora" placeholder="00:00">
      ...
      <button type="submit" class="btn btn-primary">Prenota</button>
       ...
       <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Accedi </a>
      <div class="dropdown-menu">
     <form action="/action_page.php">
